...
def build_jockey(
    ...
    instructor_filepath = os.path.join(os.path.dirname(__file__), "prompts", "instructor.md")
    ...
    with open(instructor_filepath, "r") as instructor_prompt_file:
        instructor_prompt = instructor_prompt_file.read()
