...
const ThumbnailsList: React.FC<ThumbnailsListProps> = ({videos, showAllVideos, loadedThumbnails, playerRefs, handleThumbnailClick}) => {
	...
	return (
		<motion.div className="grid grid-cols-3 gap-2 w-full pr-[2px]" variants={containerVariants} initial="hidden" animate="visible">
