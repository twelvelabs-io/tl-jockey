...
const helpersFunctions = {
	updateChatPanelMessages: (dispatch: Dispatch<any>, videoInfo: any): void => {
		dispatch({
	...
	openPanelModal: (dispatch: Dispatch<any>, videoInfo: any): void => {
		dispatch({
	...
	closeAndClearModal: (dispatch: Dispatch<any>, handleClose: () => void): void => {
	...
	openClearModal: (dispatch: Dispatch<any>): void => {
		dispatch({
			type: ActionType.SET_MODAL_TYPE,
	...
	openMessagesModal: (dispatch: Dispatch<any>, indexOfElementInArray: number, index: number | undefined): void => {
